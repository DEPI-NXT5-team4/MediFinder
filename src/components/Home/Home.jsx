        ...
        <div className="w-full max-w-[650px]">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-6 py-3 sm:py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base sm:text-lg shadow-lg"
            />
          </div>
        </div>

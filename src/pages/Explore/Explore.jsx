...
const Explore = () => {
  ...
  const getCategoryRoute = (categoryName) => {
    const routeMap = {
      'Analgesics & Antipyretics': '/categories/pain-relief-fever',
      'Pain Relief & Fever': '/categories/pain-relief-fever',
      'Antibiotics': '/categories/antibiotics',
      'Respiratory / Bronchodilators': '/categories/respiratory-health',
      'Respiratory Health': '/categories/respiratory-health',
      'Diabetes Care': '/categories/diabetes-care',
      'Gastrointestinal': '/categories/digestive-health',
      'Digestive Health': '/categories/digestive-health',
      'Cardiovascular': '/categories/heart-cholesterol',
      'Heart & Cholesterol': '/categories/heart-cholesterol',
    };

    return routeMap[categoryName] || '/explore';
  };
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {data.categories.exploreCategories.map((category) => (
              <Link
                ...
                className={`bg-gray-200 rounded-full w-full h-full flex items-center justify-between text-foreground cursor-pointer px-4 sm:px-6 py-4 mx-auto hover:bg-gray-300 transition-colors`}
              >

      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600">Review your items ({cartItemsArray.length} items)</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div key={item.id} className="bg-white rounded-2xl shadow-sm p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-bold text-blue-600">{item.price} EGP</p>
                    </div>
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    <p className="text-gray-600">Subtotal: {(item.price * item.quantity).toFixed(2)} EGP</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-6">
                ...
                <Link to="/checkout" className="w-full bg-gray-900 text-white py-3 rounded-xl hover:bg-gray-600 transition-colors font-semibold text-center block mb-3" >
                  Proceed to Checkout
                </Link>
                <Link to="/explore" className="w-full border border-gray-300 text-gray-700 py-3 rounded-xl hover:bg-gray-50 transition-colors font-medium text-center block">
                  Continue Shopping
                </Link>
              </div>
            </div>
